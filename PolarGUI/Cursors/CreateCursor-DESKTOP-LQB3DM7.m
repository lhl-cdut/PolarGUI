...
Curcolor = [0.63 0.18 0.18]; % for Fig2

% Put a label at the top and make it behave as part of the cursor
% Please change the 'Color'-Curcolor as all graph in this paper
axes(AxesList(1));
YLim=get(AxesList(1),'YLim');
th=text(xhalf, YLim(1), ['C' num2str(NumberOfCursor)],...
    'Tag','Cursor',...
