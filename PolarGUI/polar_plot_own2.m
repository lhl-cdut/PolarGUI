...
for i=0:30:330
    ...
    if i<180
        text((r_max+cNum/2)* sind(i),(r_max+cNum/2)* cosd(i),[num2str(i),'^бу'],'Color','k');
    elseif i==180
        text(r_max*sind(190),r_max*cosd(190)-cNum/2,[num2str(i),'^бу'],'Color','k');
    elseif i>180 && i<270
        text(r_max* sind(i)-cNum*1.5,r_max* cosd(i)-cNum/2,[num2str(i),'^бу'],'Color','k');
    elseif i==270
        text(r_max* sind(i)-cNum*1.5,r_max* cosd(i),[num2str(i),'^бу'],'Color','k');
    else
        text(r_max* sind(i)-cNum*1.5,r_max* cosd(i)+cNum/2,[num2str(i),'^бу'],'Color','k');
    end
end
